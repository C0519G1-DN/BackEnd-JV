...
import com.smile.mp3common.exception.FileNotFoundException;
import com.smile.mp3common.exception.FileStorageException;
import com.smile.mp3dao.entity.FileUpload;
...
public class UpLoadFileImpl implements UploadFileService {
    ...
    @Autowired
    public UpLoadFileImpl(FileUpload fileUpload) {
